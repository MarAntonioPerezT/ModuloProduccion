...
public class ProveedoresView extends VerticalLayout {
    ...
    public ProveedoresView(ProveedoresService proveedoresService, PersonasFisicasProveedoresService personasFisicasService, PersonasMoralesProveedoresService personasMoralesService) {
        ...
        tablaProveedoresPF.getGrid().addColumn(PersonasFisicasProveedor::getIdPersonaFisicaProveedor).setHeader("ID Proveedor");
        tablaProveedoresPF.getGrid().addColumn(PersonasFisicasProveedor::getNombre).setHeader("Nombre");
        tablaProveedoresPF.getGrid().addColumn(PersonasFisicasProveedor::getAPaterno).setHeader("Apellido Paterno");
        tablaProveedoresPF.getGrid().addColumn(PersonasFisicasProveedor::getAMaterno).setHeader("Apellido Paterno");
        tablaProveedoresPF.getGrid().addColumn(proveedor -> proveedor.getPersonaProveedor().getCalle()).setHeader("Calle");
        tablaProveedoresPF.getGrid().addColumn(proveedor -> proveedor.getPersonaProveedor().getCodigoPostal()).setHeader("C.P");
        tablaProveedoresPF.getGrid().addColumn(proveedor -> proveedor.getPersonaProveedor().getColonia()).setHeader("Colonia");
        tablaProveedoresPF.getGrid().addColumn(proveedor -> proveedor.getPersonaProveedor().getEmail()).setHeader("E-Mail");
        tablaProveedoresPF.getGrid().addColumn(proveedor -> proveedor.getPersonaProveedor().getEstado()).setHeader("Estado");
        tablaProveedoresPF.getGrid().addColumn(proveedor -> proveedor.getPersonaProveedor().getMunicipio()).setHeader("Municipio");
        tablaProveedoresPF.getGrid().addColumn(proveedor -> proveedor.getPersonaProveedor().getNumero()).setHeader("Número");
        tablaProveedoresPF.getGrid().addColumn(proveedor -> proveedor.getPersonaProveedor().getRfc()).setHeader("RFC");
        tablaProveedoresPF.getGrid().addColumn(proveedor -> proveedor.getPersonaProveedor().getTelefono()).setHeader("Telefono");

        tablaProveedoresPM.getGrid().removeAllColumns();
        tablaProveedoresPM.getGrid().addColumn(PersonasMoralesProveedor::getIdPersonaMoralProveedor).setHeader("ID Proveedor");
        tablaProveedoresPM.getGrid().addColumn(PersonasMoralesProveedor::getRazonSocial).setHeader("Razón Social");
        tablaProveedoresPM.getGrid().addColumn(proveedor -> proveedor.getPersonaProveedor().getCalle()).setHeader("Calle");
        tablaProveedoresPM.getGrid().addColumn(proveedor -> proveedor.getPersonaProveedor().getCodigoPostal()).setHeader("C.P");
        tablaProveedoresPM.getGrid().addColumn(proveedor -> proveedor.getPersonaProveedor().getColonia()).setHeader("Colonia");
        tablaProveedoresPM.getGrid().addColumn(proveedor -> proveedor.getPersonaProveedor().getEmail()).setHeader("E-Mail");
        tablaProveedoresPM.getGrid().addColumn(proveedor -> proveedor.getPersonaProveedor().getEstado()).setHeader("Estado");
        tablaProveedoresPM.getGrid().addColumn(proveedor -> proveedor.getPersonaProveedor().getMunicipio()).setHeader("Municipio");
        tablaProveedoresPM.getGrid().addColumn(proveedor -> proveedor.getPersonaProveedor().getNumero()).setHeader("Número");
        tablaProveedoresPM.getGrid().addColumn(proveedor -> proveedor.getPersonaProveedor().getRfc()).setHeader("RFC");
        tablaProveedoresPM.getGrid().addColumn(proveedor -> proveedor.getPersonaProveedor().getTelefono()).setHeader("Telefono");
