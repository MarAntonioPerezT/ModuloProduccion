...
public class MaterialesView extends VerticalLayout {
    ...
    public MaterialesView(MaterialesService materialesService, PersonasFisicasProveedoresService pfService, PersonasMoralesProveedoresService pmService,
        ...
        crudMaterialPF.getGrid().addColumn(Materiales::getNombre).setHeader("Nombre material").setAutoWidth(true);
        crudMaterialPF.getGrid().addColumn(Materiales::getDescripcion).setHeader("Descripción").setAutoWidth(true);
        crudMaterialPF.getGrid().addColumn(Materiales::getPrecioCompra).setHeader("Precio de compra").setAutoWidth(true);
        crudMaterialPF.getGrid().addColumn(Materiales::getUnidad).setHeader("Unidad de medida").setAutoWidth(true);
