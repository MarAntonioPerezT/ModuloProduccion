...
public class ClientesView extends VerticalLayout {
    ...
    public ClientesView(PersonasFisicasClientesService personasFisicasService, PersonasMoralesClientesService personasMoralesService, ClientesService clientesService){
        ...
        tablaClientesPF.getGrid().addColumn(PersonasFisicasCliente::getNombre).setHeader("Nombre");
        tablaClientesPF.getGrid().addColumn(PersonasFisicasCliente::getAPaterno).setHeader("Apellido Paterno");
        tablaClientesPF.getGrid().addColumn(PersonasFisicasCliente::getAMaterno).setHeader("Apellido Paterno");
        tablaClientesPF.getGrid().addColumn(cliente -> cliente.getPersonaCliente().getCalle()).setHeader("Calle");
        tablaClientesPF.getGrid().addColumn(cliente -> cliente.getPersonaCliente().getCodigoPostal()).setHeader("C.P");
        tablaClientesPF.getGrid().addColumn(cliente -> cliente.getPersonaCliente().getColonia()).setHeader("Colonia");
        tablaClientesPF.getGrid().addColumn(cliente -> cliente.getPersonaCliente().getEmail()).setHeader("E-Mail");
        tablaClientesPF.getGrid().addColumn(cliente-> cliente.getPersonaCliente().getEstado()).setHeader("Estado");
        tablaClientesPF.getGrid().addColumn(cliente -> cliente.getPersonaCliente().getMunicipio()).setHeader("Municipio");
        tablaClientesPF.getGrid().addColumn(cliente -> cliente.getPersonaCliente().getNumero()).setHeader("Número");
        tablaClientesPF.getGrid().addColumn(cliente -> cliente.getPersonaCliente().getRfc()).setHeader("RFC");
        tablaClientesPF.getGrid().addColumn(cliente-> cliente.getPersonaCliente().getTelefono()).setHeader("Telefono");
        ...
        tablaClientesPM.getGrid().addColumn(PersonasMoralesCliente::getRazonSocial).setHeader("Razón Social");
        tablaClientesPM.getGrid().addColumn(cliente -> cliente.getPersonaCliente().getCalle()).setHeader("Calle");
        tablaClientesPM.getGrid().addColumn(cliente -> cliente.getPersonaCliente().getCodigoPostal()).setHeader("C.P");
        tablaClientesPM.getGrid().addColumn(cliente -> cliente.getPersonaCliente().getColonia()).setHeader("Colonia");
        tablaClientesPM.getGrid().addColumn(cliente -> cliente.getPersonaCliente().getEmail()).setHeader("E-Mail");
        tablaClientesPM.getGrid().addColumn(cliente-> cliente.getPersonaCliente().getEstado()).setHeader("Estado");
        tablaClientesPM.getGrid().addColumn(cliente -> cliente.getPersonaCliente().getMunicipio()).setHeader("Municipio");
        tablaClientesPM.getGrid().addColumn(cliente -> cliente.getPersonaCliente().getNumero()).setHeader("Número");
        tablaClientesPM.getGrid().addColumn(cliente -> cliente.getPersonaCliente().getRfc()).setHeader("RFC");
        tablaClientesPM.getGrid().addColumn(cliente-> cliente.getPersonaCliente().getTelefono()).setHeader("Telefono");
